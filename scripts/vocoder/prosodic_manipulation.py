...
def flatten_pitch(x, fs=16000):
    ...
    log_energy = np.log(np.sum(sp + 1e-8, axis=1))  
...
if __name__ == "__main__":
    ...
    out_dir_pitch =  "sample_data/prosodic_manipulation/pitch"
    out_dir_shaped = "sample_data/prosodic_manipulation/pitch_and_intensity"
    out_dir_intensity = "sample_data/prosodic_manipulation/intensity"
